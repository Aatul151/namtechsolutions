    ...
    <footer className="bg-bg-card border-t border-border">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-text-secondary mb-4 max-w-md">
              Premium software development services for enterprises. Building scalable, 
          ...
          <div>
            ...
            <ul className="space-y-2 text-text-secondary">
              <li>Email: info@namtechsolutions.com</li>
        ...
        <div className="mt-8 pt-8 border-t border-border text-center text-text-secondary text-sm">
          <p>&copy; {new Date().getFullYear()} Namtech Solutions. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
