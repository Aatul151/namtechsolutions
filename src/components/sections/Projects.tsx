              ...
              {projects?.map((project: any, index: any) => (
                ...
                >
                  ...
                  <div
                    ...
                    onClick={() => setSelectedImage({ image: project?.payload?.banners?.fileUrl, alt: project?.payload?.name })}
                  >
                    {project?.payload?.banners &&
                      <img
                        src={APIENDPOINT + project?.payload?.banners?.fileUrl}
                  ...
                  <div className="p-5 space-y-4">
                    ...
                    {project?.payload?.details &&
                      <p className="text-sm text-text-secondary leading-relaxed line-clamp-2"
                        dangerouslySetInnerHTML={{
                          __html: project?.payload?.details
                        }}
                      >
                      </p>
                    }
                    ...
                    {project?.payload?.technologies_ref &&
                      <div className="flex flex-wrap gap-1.5">
                        <span
                          className="px-2 py-1 rounded-md bg-bg-muted text-text-secondary text-xs"
                        >
                          {project?.payload?.technologies_ref?.name}
                        </span>
                      </div>
                    }
